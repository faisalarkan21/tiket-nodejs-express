...
--
-- Host: localhost
-- Generation Time: 18 Feb 2018 pada 06.41
...
('TK', 30, '500000.00', '0.00', 'BCA NO. 98080986643 - Faisal Arkan', 'Belum Lunas');
...
('CS_', 23, 3, 'Aristides Androclesz', 'ari@gmail.com', 'U2FsdGVkX19uUKzpxsZKc9lrLvqi4rWNitGsYopoB9E=', '082769486432', 'Pria', 'Saya ingin belajar !', 0, 'bf26ddc53af53bfd5d01a75d649565e584435a0138bdbf4fb6a46e7fb8007235'),
...
('CS_', 30, 1, 'faisal arkan', 'faisalarkan21@gmail.com', 'U2FsdGVkX1+Syf8iMnoHdlOiBG5aKXy1s9YikONhdAo=', '0980980908', 'Wanita', 'saya ingin bisa !', 1, '');
...
CREATE TABLE `pembeli_validasi` (
  ...
  `hp_pembeli` varchar(225) NOT NULL,
  `uang_transfer_validasi` decimal(10,2) NOT NULL DEFAULT '0.00',
...
(23, 'Aristides Androcles', 'ari@gmail.com', '082769486432', '500000.00', 'BRI NO. 78787878741 - Sativa Ken'),
...
(30, 'faisal arkan', 'faisalarkan21@gmail.com', '0980980908', '0.00', 'Belum Konfirmasi');
...
(1, '2018-03-01', '2018-03-31', '2018-02-01', '2018-02-28', 15),
(2, '2018-05-01', '2018-05-31', '2018-04-01', '2018-04-30', 15),
(3, '2018-07-01', '2018-07-31', '2018-06-01', '2018-06-30', 15),
(4, '2018-09-01', '2018-08-31', '2018-08-01', '2018-08-31', 15);
...
('CS_', 30, '2018-02-18 06:40:33.981');
...
--
ALTER TABLE `detil_pesan_tiket`
  MODIFY `id_pembeli` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
--
